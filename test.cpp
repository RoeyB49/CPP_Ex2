...
TEST_CASE("Player Tests") {
    ...
    SUBCASE("Test Player member functions") {
        Player p1("John");
        Player p2("Doe");
        CHECK_EQ(p1.GetName(), "John");
        CHECK_EQ(p2.GetName(), "Doe");
...
TEST_CASE("Game Tests") {
    ...
    SUBCASE("Test Game constructor") {
        CHECK_EQ(game.PlayerOne.GetName(), "Alice");
        CHECK_EQ(game.PlayerTwo.GetName(), "Bob");
    }
